  ...
  return (
    <section className="-mt-28 sm:-mt-40">
      <div className="relative w-full h-[640px] sm:h-[960px]">
        <Image
          fill
          src="/Images/theme-park-hero-banner.jpg"
          alt="Gold Coast Morib International Resort Theme Park Hero Banner"
          className="object-cover"
        />
        <div className="absolute inset-0 bg-black/15" />
        <div className="absolute inset-0 flex flex-col gap-4 items-center justify-center text-white">
          <h1 className="text-lg sm:text-xl">Water Theme Park</h1>
          <p
            className={`text-center text-4xl sm:text-6xl ${cormorantGaramond.className}`}
          >
            Make Splash <br /> Make Memory
          </p>
        </div>
      </div>
      <motion.div
        ...
        className="flex flex-col sm:flex-row p-4 sm:p-24 gap-8 sm:gap-16"
      >
      ...
      <div className="flex flex-col mb-24 p-4 sm:px-24 gap-8 sm:gap-16">
